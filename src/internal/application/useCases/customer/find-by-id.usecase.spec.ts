...
import { FindCustomerById } from './find-by-id.usecase';
...
describe('FindCustomerById', () => {
  let findCustomerById: FindCustomerById;
  ...
  beforeEach(async () => {
    ...
    findCustomerById = module.get<FindCustomerById>(FindCustomerById);
  });
  ...
  describe('execute', () => {
    it('should find customer by CPF', async () => {
        ...
        const result = await findCustomerById.execute(createCustomerDto.id);
    ...
    it('should not find customer by CPF', async () => {
        ...
        try {
            customer = await findCustomerById.execute('abc');
        } catch (error) {
            // assert
